...
import java.awt.*;
import javax.swing.*;
public class stateorange {
	public class Stateorange<AbstractStatechart_monitor> extends FeuTricolore{

		private final String Orange = null;
		private final String Rouge = null;
		private final String VERT = null;
		
		public Stateorange(int a,int b,int c,int d) {
			    super(a,b,c,d);
